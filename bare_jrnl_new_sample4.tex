...
On COCO, the attack remains effective, although the magnitude of the ASR becomes more dependent on the victim architecture. BLIP-2 and InstructBLIP achieve ASRs of $0.893$ and $0.836$, respectively, while LLaVA achieves $0.545$.
...
STRIP varies across VLM architectures. The corresponding suspicion-score distributions are visualized in
Fig.~\ref{fig:defense_score_distributions}.
